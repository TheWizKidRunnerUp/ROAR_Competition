...
async def evaluate_solution(
    ...
    while True:
        ...
        print(f"speed={vehicle_speed:6.2f} m/s | mode={solution.speed_mode:12} | gain={solution.steering_gain:4.1f} | target={solution.target_speed:5.1f} m/s | lookahead={solution.lookahead_distance:2d} | is_slow_s_turn={solution.slow_s_turn_active} | reach waypoints {rule.furthest_waypoints_index}")
        await world.step()
